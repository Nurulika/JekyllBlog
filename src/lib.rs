...
#[derive(Debug)]
pub struct JekyllBlogProcessor {
    verbose: bool,
    processed_count: usize,
}

impl JekyllBlogProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting JekyllBlog processing");
    
    let mut processor = JekyllBlogProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = JekyllBlogProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = JekyllBlogProcessor::new(false);
